 ...
 * Authorization: Bearer <STATUS_TOKEN> (the response includes tunnel URLs,
 * which front_door mode otherwise hides from clients). Leave STATUS_TOKEN
 * unset to keep the endpoint open.
 */
...
export async function GET(request) {
  ...
  const describe = (m) =>
    m && {
      ...
      status: m.status,
      tunnel_url: m.cloudflare_tunnel_address || null,
